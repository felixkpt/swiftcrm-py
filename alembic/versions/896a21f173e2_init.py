...
Revision ID: 896a21f173e2
Revises: 
Create Date: 2025-04-17 14:18:13.566856
...
def upgrade() -> None:
    ...
    sa.Column('nameSingular', sa.String(length=255), nullable=True),
    sa.Column('namePlural', sa.String(length=255), nullable=True),
    sa.Column('modelURI', sa.String(length=255), nullable=True),
    sa.Column('apiEndpoint', sa.String(length=255), nullable=True),
    sa.Column('tableNameSingular', sa.String(length=255), nullable=True),
    sa.Column('tableNamePlural', sa.String(length=255), nullable=True),
    ...
    sa.UniqueConstraint('tableNamePlural'),
    sa.UniqueConstraint('tableNameSingular'),
