...
Revision ID: 4bfb53579104
Revises: 952c5b04e1c9
Create Date: 2024-07-22 18:57:50.119349
...
revision: str = '4bfb53579104'
down_revision: Union[str, None] = '952c5b04e1c9'
...
def upgrade() -> None:
    ...
    op.drop_index('name', table_name='social_media_conversation_categories')
...
def downgrade() -> None:
    ...
    op.create_index('name', 'social_media_conversation_categories', ['name'], unique=True)
