...
Revision ID: 001517e35232
Revises: 8e3bf76b034d
Create Date: 2024-07-22 20:57:18.018938
...
revision: str = '001517e35232'
down_revision: Union[str, None] = '8e3bf76b034d'
...
def upgrade() -> None:
    ...
    op.drop_index('name', table_name='social_mediaconversation_categories')
...
def downgrade() -> None:
    ...
    op.create_index('name', 'social_mediaconversation_categories', ['name'], unique=True)
