...
from app.models.schemas.auto_page_builder import AutoPageBuilderRequest
...
def generate_model_files(data: AutoPageBuilderRequest):
    ...
    listDirPath = os.path.join(os.getcwd(), 'app', 'pages', 'dashboard', modelURI)
...
def map_data_type(data_type):
    if data_type == 'integer':
        ...
        return 'VARCHAR(255)'  # Default to VARCHAR(255) if data type is unknown
