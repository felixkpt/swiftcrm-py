...
from app.repositories.admin.auto_builders.model_builder.action_labels.action_label_repo import ActionLabelRepo as Repo
from app.requests.schemas.admin.auto_builders.model_builder.action_labels.action_label import ActionLabelSchema as ModelSchema
