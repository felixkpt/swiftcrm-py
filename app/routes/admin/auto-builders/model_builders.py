...
from app.repositories.admin.auto_builders.model_builder_repo import ModelBuilderRepo as Repo
from app.requests.schemas.admin.auto_builders.model_builder import ModelBuilderSchema as ModelSchema
