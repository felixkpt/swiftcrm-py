...
from app.repositories.admin.auto_builders.model_builders2.model_builder2_repo import ModelBuilder2Repo as Repo
from app.requests.schemas.admin.auto_builders.model_builders2.model_builder2 import ModelBuilder2Schema as ModelSchema
...
# Create a new Model_builder2 instance.
...
# Update statuses of multiple Model_builder2s.
@router.put("/statuses")
