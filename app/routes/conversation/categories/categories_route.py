...
from app.repositories.conversation.categories.category_repo import CategoryRepo as Repo
from app.requests.schemas.conversation.categories.category import CategorySchema as ModelSchema
