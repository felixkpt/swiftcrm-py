...
from app.repositories.conversation.categories.sub_categories.sub_category_repo import SubCategoryRepo as Repo
from app.requests.schemas.conversation.categories.sub_categories.sub_category import SubCategorySchema as ModelSchema
