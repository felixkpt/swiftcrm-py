...
from app.repositories.conversation.v2.categories.category_repo import CategoryRepo as Repo
from app.requests.schemas.conversation.v2.categories.category import CategorySchema as ModelSchema
