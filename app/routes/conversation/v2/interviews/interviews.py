...
from app.repositories.conversation.v2.interviews.interview_repo import InterviewRepo as Repo
from app.requests.schemas.conversation.v2.interviews.interview import InterviewSchema as ModelSchema
