...
from app.repositories.conversation.v2.messages.message_repo import MessageRepo as Repo
from app.requests.schemas.conversation.v2.messages.message import MessageSchema as ModelSchema
