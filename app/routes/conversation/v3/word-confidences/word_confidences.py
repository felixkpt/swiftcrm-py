...
from app.repositories.conversation.v3.word_confidences.word_confidence_repo import WordConfidenceRepo as Repo
from app.requests.schemas.conversation.v3.word_confidences.word_confidence import WordConfidenceSchema as ModelSchema
