...
from app.repositories.conversation.v3.categories.sub_categories.questions.question_repo import QuestionRepo as Repo
from app.requests.schemas.conversation.v3.categories.sub_categories.questions.question import QuestionSchema as ModelSchema
