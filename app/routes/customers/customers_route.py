...
from app.repositories.customers.customer_repo import CustomerRepo as Repo
from app.requests.schemas.customers.customer_schema import CustomerSchema as ModelSchema
...
# Update statuses of multiple Customers.
@router.put("/statuses")
