...
from app.repositories.api.places.place_repo import PlaceRepo as Repo
from app.requests.schemas.api.places.place_schema import PlaceSchema as ModelSchema
...
# Update statuses of multiple Places.
@router.put("/statuses")
