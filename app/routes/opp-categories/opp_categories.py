...
from app.repositories.opp_categories.opp_category_repo import OppCategoryRepo as Repo
from app.requests.schemas.opp_categories.opp_category import OppCategorySchema as ModelSchema
...
def view_route(model_id: int, db: Session = Depends(get_db)):
    ...
    if result is None:
        raise HTTPException(status_code=404, detail="Opp_category not found")
    return result
