...
from app.repositories.opportunities.opportunity_repo import OpportunityRepo as Repo
from app.requests.schemas.opportunities.opportunity import OpportunitySchema as ModelSchema
