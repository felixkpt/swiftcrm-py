...
from app.repositories.companies.company_repo import CompanyRepo as Repo
from app.requests.schemas.companies.company import CompanySchema as ModelSchema
