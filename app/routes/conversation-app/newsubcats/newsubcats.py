...
from app.repositories.newsubcat_repo import NewsubcatRepo as Repo
from app.requests.schemas.newsubcat import NewsubcatSchema as ModelSchema
...
def view_route(model_id: int, db: Session = Depends(get_db)):
    ...
    if result is None:
        raise HTTPException(status_code=404, detail="Newsubcat not found")
    return result
