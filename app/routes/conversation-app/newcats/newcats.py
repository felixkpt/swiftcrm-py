...
from app.repositories.newcat_repo import NewcatRepo as Repo
from app.requests.schemas.newcat import NewcatSchema as ModelSchema
...
def view_route(model_id: int, db: Session = Depends(get_db)):
    ...
    if result is None:
        raise HTTPException(status_code=404, detail="Newcat not found")
    return result
