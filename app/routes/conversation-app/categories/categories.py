...
from app.repositories.conversation_app.categories.category_repo import CategoryRepo as Repo
from app.requests.schemas.conversation_app.categories.category import CategorySchema as ModelSchema
