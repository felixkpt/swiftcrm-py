...
from app.repositories.conversation_app.categories.sub_categories.sub_category_repo import SubCategoryRepo as Repo
from app.requests.schemas.conversation_app.categories.sub_categories.sub_category import SubCategorySchema as ModelSchema
