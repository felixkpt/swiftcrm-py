...
from app.repositories.conversation_app.categories.sub_categories.questions.question_repo import QuestionRepo as Repo
from app.requests.schemas.conversation_app.categories.sub_categories.questions.question import QuestionSchema as ModelSchema
