...
from app.repositories.conversation_app.v3.categories.sub_categories.sub_category_repo import SubCategoryRepo as Repo
from app.requests.schemas.conversation_app.v3.categories.sub_categories.sub_category import SubCategorySchema as ModelSchema
