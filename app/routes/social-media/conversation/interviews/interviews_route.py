...
from app.repositories.social_media.conversation.interviews.interview_repo import InterviewRepo as Repo
from app.requests.schemas.social_media.conversation.interviews.interview_schema import InterviewSchema as ModelSchema
