...
from app.requests.schemas.social_media.conversation.categories.category import CategorySchema as ModelSchema
...
# Retrieve counts or statistics related to Categorys.
@router.get("/counts")
...
# Update statuses of multiple Categorys.
@router.put("/statuses")
