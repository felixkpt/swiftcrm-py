...
from app.repositories.social_media.conversation.categories.sub_categories.sub-category_repo import SubCategoryRepo as Repo
from app.requests.schemas.social_media.conversation.categories.sub_categories.sub-category import SubCategorySchema as ModelSchema
...
# Retrieve a list of Sub-categories.
@router.get("/")
...
# Update statuses of multiple Sub-categories.
@router.put("/statuses")
