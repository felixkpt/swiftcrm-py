...
from app.repositories.social_media.conversation.categories.sub_categories.sub_category_repo import SubCategoryRepo as Repo
from app.requests.schemas.social_media.conversation.categories.sub_categories.sub_category_schema import SubCategorySchema as ModelSchema
