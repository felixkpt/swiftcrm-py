...
from app.repositories.social_media.conversation.categories.sub_categories.category_repo import CategoryRepo as Repo
from app.requests.schemas.social_media.conversation.categories.sub_categories.category_schema import CategorySchema as ModelSchema
