...
from app.repositories.social_media.conversation.messages.message_repo import MessageRepo as Repo
from app.requests.schemas.social_media.conversation.messages.message_schema import MessageSchema as ModelSchema
