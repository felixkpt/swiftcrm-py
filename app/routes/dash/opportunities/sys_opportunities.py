...
from app.repositories.sys_opportunity_repo import SysOpportunityRepo as Repo
from app.requests.schemas.sys_opportunity import SysOpportunitySchema as ModelSchema
...
def view_route(model_id: int, db: Session = Depends(get_db)):
    ...
    if result is None:
        raise HTTPException(status_code=404, detail="sys-opportunities not found")
    return result
