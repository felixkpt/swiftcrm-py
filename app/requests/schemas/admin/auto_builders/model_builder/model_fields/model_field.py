...
class ModelFieldSchema(BaseModel):
    ...
    isVisibleInList: int = Field(..., max_length=None)
    isVisibleInSingleView: int = Field(..., max_length=None)
    isRequired: int = Field(..., max_length=None)
    isUnique: int = Field(..., max_length=None)
