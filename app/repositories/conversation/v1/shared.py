...
class SharedRepo:
    ...
    @staticmethod
    def get_interview_question(sub_cat_id, user_id, update=False):
        ...
        if not session:
            if update:
                ...
                session = {'id': interview_id, 'current_question_id': question_id}
        else:
    ...
    @staticmethod
    def get_sub_cat_conversation(sub_cat_id, mode='training', interview_id=None):
        ...
        if mode == 'interview':
            progress = SharedRepo.interview_progress(interview_id, sub_cat_id)
    ...
    @staticmethod
    def interview_progress(interview_id, sub_cat_id):
        interview_question = SharedRepo.get_interview_question(sub_cat_id, user_id=1)
        current_interview_message = SharedRepo.get_current_interview_message(interview_id, role='user')
