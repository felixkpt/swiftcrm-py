...
from app.models.conversation.categories.sub_categories.sub_category import ConversationCategoriesSubCategory as Model
...
class SubCategoryRepo(BaseRepo):
    ...
    async def create(self, db: Session, model_request):
        required_fields = ['sub_category_id']
        unique_fields = []
