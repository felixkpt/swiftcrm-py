...
from app.models.social_media.conversation.categories.sub_categories.sub-category_model import SocialMediaConversationCategoriesSubCategory as Model
...
class SubCategoryRepo(BaseRepo):
    ...
    async def list(self, db: Session, request: Request):
        ...
        search_fields = ['sub_category_id', 'name', 'learn_instructions']
    ...
    async def create(self, db: Session, model_request):
        required_fields = ['sub_category_id', 'name', 'learn_instructions']
        unique_fields = []
