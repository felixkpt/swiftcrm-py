...
from app.models.auto_page_builder.auto_page_builder import AutoPageBuilder
from app.models.auto_page_builder.auto_page_builder_field import AutoPageBuilderField
from app.models.auto_page_builder.auto_page_builder_action_label import AutoPageBuilderActionLabel
from app.models.auto_page_builder.auto_page_builder_header import AutoPageBuilderHeader
...
class AutoPageBuilderRepo:
    ...
    def get_pages(db: Session):
        records = db.query(AutoPageBuilder).all()
        results = {
            'records': records,
            'metadata': None,
        }
