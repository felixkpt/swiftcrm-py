...
from app.models.conversation_app.categories.sub_categories.sub_category import ConversationAppCategoriesSubCategory as Model
...
class SubCategoryRepo:
    ...
    async def list(db: Session, request: Request):
        ...
        search_fields = ['conversation_app_category_id', 'name', 'learn_instructions']
    ...
    def create(db: Session, model_request):
        required_fields = ['conversation_app_category_id', 'name', 'learn_instructions']
        unique_fields = []
