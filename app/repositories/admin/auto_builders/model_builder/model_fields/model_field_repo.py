...
class ModelFieldRepo(BaseRepo):
    ...
    async def list(self, db: Session, request: Request):
        ...
        search_fields = ['model_builder_id', 'name', 'type', 'label', 'dataType', 'isVisibleInList', 'isVisibleInSingleView', 'isRequired', 'isUnique', 'desktopWidth', 'mobileWidth']
    ...
    async def create(self, db: Session, model_request):
        required_fields = ['model_builder_id', 'name', 'type', 'label', 'dataType', 'isVisibleInList', 'isVisibleInSingleView', 'isRequired', 'isUnique', 'desktopWidth', 'mobileWidth']
        unique_fields = []
