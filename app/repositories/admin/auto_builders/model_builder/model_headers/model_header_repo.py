...
class ModelHeaderRepo(BaseRepo):
    ...
    async def list(self, db: Session, request: Request):
        ...
        search_fields = ['model_builder_id', 'key', 'label', 'isVisibleInList', 'isVisibleInSingleView']
    ...
    async def create(self, db: Session, model_request):
        required_fields = ['model_builder_id', 'key', 'label', 'isVisibleInList', 'isVisibleInSingleView']
        unique_fields = []
