...
class ConversationV3Message(Base):
    ...
    interview = relationship("ConversationV3Interview", back_populates="messages")
    word_confidences = relationship("ConversationV3MessagesWordConfidence", back_populates="message")
