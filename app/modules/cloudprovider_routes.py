...
from app.modules.cloudprovider_repo import CloudproviderRepo as Repo
from app.modules.cloudprovider_schema import CloudproviderSchema as ModelSchema
...
# Create a new Cloudprovider instance.
...
# Update statuses of multiple Cloudproviders.
@router.put("/statuses")
