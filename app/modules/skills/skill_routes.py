...
from app.modules.skills.skill_repo import SkillRepo as Repo
from app.modules.skills.skill_schema import SkillSchema as ModelSchema
...
# Update statuses of multiple Skills.
@router.put("/statuses")
