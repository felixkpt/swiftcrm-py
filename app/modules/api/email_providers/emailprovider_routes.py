...
from app.modules.api.email_providers.emailprovider_repo import EmailproviderRepo as Repo
from app.modules.api.email_providers.emailprovider_schema import EmailproviderSchema as ModelSchema
...
# Create a new Emailprovider instance.
...
# Update statuses of multiple Emailproviders.
@router.put("/statuses")
