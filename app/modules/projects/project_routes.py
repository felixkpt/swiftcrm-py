...
from app.modules.projects.project_repo import ProjectRepo as Repo
from app.modules.projects.project_schema import ProjectSchema as ModelSchema
...
# Retrieve counts or statistics related to Projects.
@router.get("/counts")
...
# Update statuses of multiple Projects.
@router.put("/statuses")
