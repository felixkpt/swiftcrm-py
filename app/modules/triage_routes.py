...
from app.modules.triage_repo import TriageRepo as Repo
from app.modules.triage_schema import TriageSchema as ModelSchema
...
# Update statuses of multiple Triages.
@router.put("/statuses")
