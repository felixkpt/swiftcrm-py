...
def get_default_content(api_endpoint_dotnotation, model_path_name, className, model_name_pascal, fields, repo_specific_filters, inserts_args1, inserts_args2):
    content = f"""
from datetime import datetime
from fastapi import Request
from sqlalchemy.orm import Session
from sqlalchemy.exc import IntegrityError
from app.modules.{build_dot_namespace(api_endpoint_dotnotation, model_path_name)} import {className} as Model
