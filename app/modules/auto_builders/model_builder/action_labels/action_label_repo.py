...
from app.modules.auto_builders.model_builder.action_labels.action_label_model import AutoBuildersModelBuilderActionLabel as Model
...
class ActionLabelRepo(BaseRepo):
    ...
    async def create(self, db: Session, model_request):
        ...
        db_query = Model(
            ...
            actionType = str(model_request.actionType).strip(),
    ...
    async def update(self, db: Session, model_id: int, model_request):
        ...
        if db_query:
            ...
            db_query.actionType = str(model_request.actionType).strip()
